...
public class Water : MonoBehaviour
{
	...
	void UpdateMaterial()
	{
        ...
        if (rockMaterial)
        {
            rockMaterial.SetTexture("_NormalTex", settings.normalTexture);
            rockMaterial.SetVector("_WindDirection", settings.windDirection);
            rockMaterial.SetFloat("_WindSpeed", settings.windSpeed);
            rockMaterial.SetFloat("_Visibility", settings.visibility);
            rockMaterial.SetFloat("_WaveScale", settings.waveScale);
            rockMaterial.SetColor("_MudExtinction", settings.mudExtinction);
            rockMaterial.SetColor("_WaterExtinction", settings.waterExtinction);
            rockMaterial.SetVector("_SunTransmittance", transmittance);
            rockMaterial.SetFloat("_SunFade", sunFade);
            rockMaterial.SetFloat("_ScatterFade", scatterFade);
        }
    }
